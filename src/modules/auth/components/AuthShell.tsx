...
export function AuthShell({ heading, subheading, children, footer }: AuthShellProps) {
  return (
    <>
      ...
      />
      <div
        className="fixed inset-0 overflow-auto flex items-center justify-center px-4 py-12"
          ...
          >
            <div className="mb-6">
              <h1
                ...
                style={{ fontSize: '24px', color: '#111827', letterSpacing: '-0.3px' }}
              >
                {heading}
              </h1>
