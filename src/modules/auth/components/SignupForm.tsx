  ...
  return (
    <AuthShell
      ...
      footer={
        <p className="text-sm text-slate-500">
          ...
          <Link to="/login" className="text-violet-400 hover:text-violet-300 font-medium transition-colors underline underline-offset-2">
            Sign in
          </Link>
        </p>
      }
    >
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
        ...
        <div className="space-y-1.5">
          <label htmlFor="confirmPassword" className="block text-xs font-semibold tracking-widest uppercase text-slate-500">
            Confirm Password
          </label>
          <input
            id="confirmPassword"
